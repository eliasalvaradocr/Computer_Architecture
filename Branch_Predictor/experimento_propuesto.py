...
'''
En el presente código "experimento_propuesto.py" se evalua y compara el rendimiento
del predictor propuesto ie0521_bp en diferentes configuraciones. Entonces se crea una tabla 
...
print("\n")
print("Tabla con Resultados para Predictor ie0521_bp \n")
...
for global_history_size in global_history_size_values:
    ...
    for bits_to_index in bits_to_index_values:
        ...
        command = f"python branch_predictor.py --bp 4 -n {bits_to_index} -g {global_history_size}"
...
ax.set_title("Porcentaje de Predicciones Correctas (ie0521_bp)")
